% main function of gradient descent for ridge regression
...
for idx = 1:4
    ...
    pic_name = sprintf('pic_%d',idx); %file name
    ...
    %maximal interation times
    iterations = 1000;
    alpha = 0.001; %descent rate
    ...
    if idx == 1
       figure,plot(b,a,'or','markersize',10);
       hold on
    ...
    [train_val_err test_err trainVar testVar] = gradient_descent_test(X, y, Xtest, Ytest, iterations, b);
